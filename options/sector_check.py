...
SECTOR_SHADOW_LOG = SCRIPT_DIR / "options_sector_shadow_log.json"
...
# Includes both stocks pipeline and options pipeline catalyst type names
POSITIVE_CATALYSTS = {
    "earnings", "merger", "upgrade",
    "EARNINGS_BEAT", "MA_ANNOUNCEMENT", "ANALYST_UPGRADE",
    "GAP_UP", "MACRO_POSITIVE",
}
# Catalyst types that indicate negative sector sentiment
NEGATIVE_CATALYSTS = {
    "downgrade", "leadership",
    "EARNINGS_MISS", "ANALYST_DOWNGRADE",
    "GAP_DOWN", "MACRO_NEGATIVE",
}
...
def log_sector_comparison(
    ...
    """Append sector corroboration entry to options_sector_shadow_log.json."""
    entry = {
